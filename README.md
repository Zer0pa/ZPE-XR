...
<sub>02 · ZPE XR animated mechanics diagram · b-cell b-codec-mechanics cell-5 row-2</sub>
<figure>
...
<div><b>02 · MARKETS</b><span>ADJACENT FORECASTS</span></div>
      <div>
        <div>
          <div><span>Release posture</span><span></span><span>BLOCKED</span></div>
          <div><span>Hand tracking solutions</span><span></span><span>$10.9B '33</span></div>
          <div><span>Extended Reality market</span><span></span><span>$59.2B '31</span></div>
          <div><span>Spatial computing</span><span></span><span>$280B '28</span></div>
          <div><span>Ultraleap ref revenue</span><span></span><span>~$30M</span></div>
        </div>
      </div>
...
<div><b>05.3 · BENCHMARKS</b><span>CONTACTPOSE MEASURED</span></div>
      <div>
        ...
        <div>
          <div><span>Transport size</span><span></span><span>PASS</span></div>
          <div><span>Round-trip speed</span><span></span><span>PASS</span></div>
          <div><span>Fidelity</span><span></span><span>MISS</span></div>
        </div>
      </div>
...
<div><b>06.1 · COMPARATIVE PERFORMANCE</b><span>CONTACTPOSE BYTES PER FRAME</span></div>
      <div>
        <div>
          <div><span>ZPE-XR</span><span></span><span>25.9 bytes/frame</span></div>
          <div><span>float16+zlib</span><span></span><span>~110 bytes/frame</span></div>
          <div><span>raw float32</span><span></span><span>619.5 bytes/frame</span></div>
          <div><span>comparator fidelity</span><span></span><span>0/5</span></div>
        </div>
      </div>
