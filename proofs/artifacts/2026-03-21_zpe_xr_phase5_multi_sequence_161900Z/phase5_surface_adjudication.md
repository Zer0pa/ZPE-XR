...
- `pip install zpe-xr` package mechanics validated locally
- real-data ContactPose evidence with strong raw-vs-quality metrics
- bounded claim set with no incumbent-displacement or runtime-completion inflation

This is the strongest supported surface because the repo now has a real Rust-backed package, a passing cold-start audit, and a five-sequence outward-safe ContactPose rerun with strong metrics. What it does not have is public comparator superiority.

## Section 2 - Branch Classification
